...
function ImageBehavior.handlers:uiComponent(component, opts)
    ...
    self:uiValue(
        "dropdown",
        "scaling style",
        component.properties.filter == "nearest" and "pixelated" or "smooth",
        {
            props = {items = {"pixelated", "smooth"}},
            onChange = function(params)
